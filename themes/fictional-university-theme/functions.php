...
function pageBanner($args = NULL){
    ...
    if(!isset($args['subtitle'])){
        $args['subtitle'] = get_field('page_banner_sub_text');
    }
    if(!isset($args['photo'])){
...
function university_features(){
    ...
    add_image_size('professorPort', 480, 650, true);
...
// Redirect Subscribers to Home page and remove admin bar 
